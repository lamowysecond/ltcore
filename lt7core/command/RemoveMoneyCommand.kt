...
class RemoveMoneyCommand : CommandExecutor {
    override fun onCommand(
        ...
        if (args.size < 2) {
            sender.sendMessage(LTCore.PREFIX + LTCore.langManager.getString(sender as Player, "command.usage", mapOf("%usage" to "/removemoney <player> <amount>")))
            return false
        }
        ...
        MoneySystem.removeMoneyCommand(sender as Player, args[0], money)
        return true
    }
}