...
class BanIPCommand : CommandExecutor {
    override fun onCommand(
        ...
        if (args.size < 2) {
            senderP.sendMessage(LTCore.PREFIX + langManager.getString(senderP, "command.usage", mapOf("%usage" to "/banIP <ip> <reason>")))
            return false
        }
        ...
        PunishmentSystem.banIP(senderP, targetName, reasonType, reason, null)
        return true
    }
}