...
class HomeCommand  : CommandExecutor {
    override fun onCommand(
        ...
        if (args.isEmpty()) {
            sender.sendMessage(LTCore.PREFIX + langManager.getString(sender as Player, "command.usage", mapOf("%usage" to "/home <name>")))
            return false
        }
        HomesSystem.home(sender as Player, args[0])
        return true
    }
}