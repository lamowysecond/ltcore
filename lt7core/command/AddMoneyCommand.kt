...
class AddMoneyCommand : CommandExecutor {
    override fun onCommand(
        ...
        if (args.size < 2) {
            sender.sendMessage(LTCore.PREFIX + LTCore.langManager.getString(sender as Player, "command.usage", mapOf("%usage" to "/addmoney <player> <amount>")))
            return false
        }
        ...
        MoneySystem.addMoneyCommand(sender as Player, args[0], money)
        return true
    }
}