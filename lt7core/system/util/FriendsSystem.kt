...
object FriendsSystem : Listener {
    ...
    fun addFriend(player: Player, friend: String) {
        ...
        friendPlayer.sendMessage(LTCore.PREFIX + langManager.getString(player, "friends.request_received", mapOf("%p" to player.name)))
        friendPlayer.sendMessage(Component.text(langManager.getString(player, "friends.request_accept_btn"))
