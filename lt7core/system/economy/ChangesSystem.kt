                    ...
                    GuiButton(
                        ...
                        ),
                        {
                            if (MoneySystem.getBalance(player.name) < money) {
                                player.sendMessage(LTCore.PREFIX + langManager.getString(player, "changes.insufficient_funds", mapOf("%b" to MoneySystem.getBalance(player.name).toString(), "%i" to money.toString())))
